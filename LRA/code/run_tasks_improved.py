...
parser.add_argument("--no_copy_rv", help="Cur desabling copy rv",
...
if attn_type == "curformer":
    ...
    checkpoint_dir = f"../logs/improved_{task}_curformer_{args.select_type}{args.select_number}" \
